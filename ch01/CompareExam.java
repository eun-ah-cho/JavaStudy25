...
public class CompareExam {
	...
	public static void main(String[] args) {
		...
		*/
		...
		// boolean 타입은 true, false 값을 갖을수 있다.
		System.out.println(result1);
	
		char char1 = '1';  //유니코드 65 소문자a는 97   char에서 '1'은 유니코드
		char char2 = 1 ;  // 유니코드 66 
		...
		// 비교 연산자에 타입이 다른 변수를 비교하면 자동 타입 변환이 일어남.
		...
		System.out.println((float)v4 == v5); // v4를 float 형으로 변환  //true 
		System.out.println("=======================================");
		System.out.println(v4 == (double)v5); // 자동타입 변환임  //false 
