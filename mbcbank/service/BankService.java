...
public class BankService { // 서비스 계층은 crud 메서드 위주로 생성한다.
	...
	private AccountDTO findAccount(String ano, HanaAccountDTO[] hanaBank) {
	...
	// 계좌번호를 입력하고 출금액을 입력하면 계좌번호를 찾아서 계좌잔액을 감소 시킨다.
				...
				if(inputAccount.getBalance() < outmoney) {
					System.out.println("잔액이 부족하여 출금하실 수 없습니다. ");
					System.out.println("현재 잔액은" + inputAccount.getBalance() + "입니다.");
				}
				else {
				System.out.println("현재 잔액은" + inputAccount.getBalance() + "원 입니다.");
				inputAccount.setBalance(inputAccount.getBalance() - outmoney);
				System.out.println(inputAccount.getOwner() + "님 출금이 성공되었습니다.");
				System.out.println("남은 잔액 : " + inputAccount.getBalance() + "원");
				System.out.println("================================");
				}
